...
from he_core_ast import (
    TokenType, Token, Lexer, ASTNode, ProgramNode, TypeNode,
    VarDeclNode, AssignNode, NumberNode, StringNode, BooleanNode, NullNode,
    IdentifierNode, BinaryOpNode, UnaryOpNode, FunctionParam, FunctionDefNode,
    LambdaNode, StructDefNode, TraitDefNode, ImplBlockNode, TypeAliasNode,
    EnumDefNode, UnsafeBlockNode, SpawnNode, TestBlockNode, AssertNode,
    MatchNode, TryCatchNode, MemberAccessNode, NullCoalesceNode, ArrayNode,
    IndexAccessNode, IfNode, WhileNode, ForNode, ReturnNode, BreakNode,
    ContinueNode, FunctionCallNode
)
...
class Parser:
    ...
    def parse_statement(self) -> Optional[ASTNode]:
        ...
        if tok.type == TokenType.FOR:
            ...
            body = self.parse_block()
            return ForNode(var_name, start_expr, end_expr, body, tok.line, tok.col)
