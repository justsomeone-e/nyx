...
class UniversalCodeGen:
    ...
    def gen_cpp(self) -> str:
        lines = [
            "// Auto-generated by Nyx Enterprise Compiler (hecpp - C++20)",
            "#include <iostream>",
            "#include <string>",
            "#include <vector>",
            "#include <map>",
    ...
    def gen_python(self) -> str:
        lines = [
            "# Auto-generated by Nyx Titan Compiler (hepy)",
    ...
    # =====================================================
    def gen_js(self) -> str:
        lines = ["// Auto-generated by Nyx (hejs)\n"]
        for s in self.ast.statements:
            if isinstance(s, VarDeclNode):
                val_s = str(s.expr.value) if isinstance(s.expr, (NumberNode, StringNode, BooleanNode)) else "null"
