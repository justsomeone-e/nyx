...
INTRINSICS: Dict[str, BuiltinSignature] = {
    "_nyx_destructure_check": _exact((ANY, INT, STRING), ANY),
    ...
    "_nyx_base64_decode_result": _exact((STRING,), IRType("Result", (STRING, STRING))),
    ...
    "_nyx_fs_read_to_string_result": _exact((STRING,), IRType("Result", (STRING, STRING))),
    "_nyx_fs_write_string_result": _exact((STRING, STRING), IRType("Result", (BOOL, STRING))),
    "_nyx_fs_append_string_result": _exact((STRING, STRING), IRType("Result", (BOOL, STRING))),
    "_nyx_fs_remove_file_result": _exact((STRING,), IRType("Result", (BOOL, STRING))),
    "_nyx_json_get_string": _exact((STRING, STRING), STRING),
    "_nyx_json_get_int": _exact((STRING, STRING), INT),
    "_nyx_json_get_string_result": _exact((STRING, STRING), IRType("Result", (STRING, STRING))),
    "_nyx_json_get_int_result": _exact((STRING, STRING), IRType("Result", (INT, STRING))),
    ...
    "_nyx_net_tcp_connect_result": _exact((STRING, INT), IRType("Result", (INT, STRING))),
    "_nyx_net_tcp_send_result": _exact((INT, STRING), IRType("Result", (BOOL, STRING))),
    "_nyx_net_tcp_recv_result": _exact((INT, INT), IRType("Result", (STRING, STRING))),
    "_nyx_net_tcp_close_result": _exact((INT,), IRType("Result", (BOOL, STRING))),
