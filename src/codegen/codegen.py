...
class UniversalCodeGen:
    ...
    def gen_cpp(self) -> str:
        """Emit hosted cpp from HIR; retain legacy freestanding targets temporarily."""
    ...
    def _gen_cpp_legacy(self) -> str:
        ...
        lines = [
            "// Auto-generated by nyx Systems Compiler (cpp - C++20)",
        ]
    ...
    def gen_wasm(self) -> str:
        wat_lines = [
            ";; Auto-generated by Nyx (wasm - WebAssembly)",
            "(module",
    ...
    def gen_react(self) -> str:
        lines = [
            "// Auto-generated by nyx Reactive Systems Compiler (react - React 19 TSX)",
    ...
    def _gen_python_legacy(self) -> str:
        ...
        lines = [
            "# Auto-generated by Nyx Compiler (python)",
